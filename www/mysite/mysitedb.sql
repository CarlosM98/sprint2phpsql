...
CREATE TABLE `tComentarios` (
  ...
  `fecha_coment` date DEFAULT curdate(),
  PRIMARY KEY (`id`),
...
(1,'Una explicación profunda del alma humana.',1,1,'2025-10-15'),
(2,'La visión del futuro es inquietante y demasiado cercana.',2,2,'2025-10-15'),
(3,'Una historia que pesa, que duele pero que tambien libera.',3,3,'2025-10-15'),
(4,'Una lectura espiritual que da paz y preguntas al mismo tiempo.',4,4,'2025-10-15'),
(5,'Crudo directo y lleno de silencios que dicen mucho.',5,5,'2025-10-15'),
(20,'hgf',NULL,1,'2025-10-15'),
(21,'hola',NULL,1,'2025-10-15'),
(22,'que',NULL,1,'2025-10-15'),
(23,'mal',NULL,1,'2025-10-15'),
(24,'tu que tal',NULL,1,'2025-10-15');
...
(1,'El lobo estepario','https://ritualdelaspalabras.wordpress.com/wp-content/uploads/2016/04/lobo-estepario.jpg','Herman Hesse',1927),
...
-- Dump completed on 2025-10-15 16:59:39
